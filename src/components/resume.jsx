...
function Experience() {
    return (
        ...
        <div className="complex-position">
            ...
            <Position title="Account executive" date="2017"/>
            <Position title="Coordinator" date="2016"/>
            <Position title="PR Intern" date="2016"/>
        </div>
...
function Clients() {
    return (
        <section className="clients-and-skills">
            <h4>Clients</h4>
            <p>Tiffany & Co. • Aritzia  • COS • Roots • Frank And Oak • WANT Les Essentiels • Fleur du Mal • Avenue Road • Canadian Arts and Fashion Awards • GOODEE • KOTN • Kanuk</p>
        </section>
    )
}
...
function Services() {
    return (
        <section className="clients-and-skills">
            <h4>Services and expertise</h4>
            <p>Brand strategy, brand voice & tone, brand positioning</p>
            <p>Campaign strategy, media relations, events, copywriting, project management</p>
        </section>
    )
}
